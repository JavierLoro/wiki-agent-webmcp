...
export function resetDatabase(): void { db.transaction(() => db.exec("DELETE FROM session_items;DELETE FROM activity_events;DELETE FROM decision_proposals;DELETE FROM agent_runs;DELETE FROM knowledge_items;DELETE FROM decisions;DELETE FROM tasks;DELETE FROM workspaces;"))(); seedDatabase(); backfillActivity(); }
seedDatabase();
